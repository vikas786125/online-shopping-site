...
<form method="post" action="insert_product.php" enctype="multipart/form-data">
	<table width="700px" align="center" border="1" bgcolor="#3399CC">
		<tr align="center">
		...
		<tr>
			<td align="right"><b>Product Category</b>
				<select name="product_cat">
					<option align="right">select a category</option>
					<?php
		...
		<tr>
			...
			<td><input type="text"name="product_price" size="50px"/></td>
		</tr>
		<tr>
    ...
    if(isset($_POST['insert_product'])){
     ...
     $insert_product="insert into products (cat_id,brand_id,date,product_title,product_img1,product_img2,product_img3,product_price,product_desc,status,product_keywords) values('$product_cat','$product_brand',NOW(),'$product_title','$product_img1','$product_img2','$product_img3','$product_price','$product_desc','$status','$product_keywords')";
			...
			if($run_product){
				...
				echo"<script>alert('products are inserted succesfully')</script>";
			}
			else{
				echo"<script>alert('product not insertted')</script>";
			}
		}
