			...
			<div  id="product_box">
              ...
              if(isset($_GET['pro_id'])){
				...
				while($row_products = mysqli_fetch_array($run_products))
				{
					...
					echo"<div id='single_product'><h1>$pro_title</h1>
					    <img src='admin_area/product_images/$pro_image1' width='190' height='190' style='border:2px solid #333;' />
					    <img src='admin_area/product_images/$pro_image2' width='190' height='190' style='border:2px solid #333;' />
					    <img src='admin_area/product_images/$pro_image3' width='190' height='190' style='border:2px solid #333;' /><br>
						<p><b>Price:INR $pro_price </b></p>
						<a href='index.php?pro_id=$pro_id' style='float:left;'>Go Back</a>
						<a href='index.php?add_cart=$pro_id'><button style='float:right;'><h3>Add to cart</h3></button></a><br>
						<p><b><u>Product Description</u><br>  </b></p>
						<p>$pro_desc</p>
						</div>
						";
				}	
