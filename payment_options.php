     ...
     <div class="main_wrapper">
	   ...
	   <div class="content_wrapper">
		 ...
		 cart();
		   ...
		   <div id="navbar1">
		       <div>
           <b style="float:right;">&nbsp Welcome Guest!</b>&nbsp
			   <b style="color:yellow; float:right; "><a href="cart.php" style="color: #FF0;"> Go to Cart</a></b>&nbsp
				   <span style="float:right;">- Total Items:- <?php items(); ?> Total Price:<?php total_price(); ?>
				  &nbsp 	<a href="logout.php" style="color: #F93">&nbsp Logout &nbsp</a>
				   </span>
			...
			<div  id="product_box">
			  <div align="center">
				...
				<b>Pay with PayPal</b><a href="www.paypal.com"><img src="images/paypal.jpg" width="200" height="100"></a><b>Or</b><a href="order.php?c_id=<?php echo $customer_id; ?>">Pay Offline</a>
				</b><br><br><br>
